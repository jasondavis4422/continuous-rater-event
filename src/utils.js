...
export const userGroup = 'Prolific Group Final (Event Segmentation)' // for current HIT
...
// stimuli variables      
export const ratingTypes = ['narrative', 'emotional', 'auditory', 'visual']; // array of rating types   
